        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banner-one.update') }}" method="POST" class="x-form-one"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="py-3">
                                    <x-admin.image-preview width="150px"
                                        src="{{ asset($bannerSection?->background_image_one) }}" />
                                </div>
                                <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banner-two.update') }}" method="POST" class="x-form-two"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="py-3">
                                    <x-admin.image-preview width="150px"
                                        src="{{ asset($bannerSection?->background_image_two) }}" />
                                </div>
                                <div class="col-12">
