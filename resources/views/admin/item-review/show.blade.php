                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                @if ($item->status == 'approved')
                                                    <span class="badge bg-green text-green-fg">{{ __('Approved') }}
                                                    </span>
                                                @elseif($item->status == 'pending')
                                                    <span
                                                        class="badge bg-yellow text-yellow-fg">{{ __('Pending') }}
                                                    </span>
                                                @elseif($item->status == 'soft_rejected')
                                                    <span
                                                        class="badge bg-cyan text-cyan-fg">{{ __('Soft Reject') }}
                                                    </span>
                                                @elseif($item->status == 'hard_rejected')
                                                    <span
                                                        class="badge bg-red text-red-fg">{{ __('Hard Reject') }}
                                                    </span>
                                                @elseif($item->status == 'resubmitted')
                                                    <span
                                                        class="badge bg-indigo text-indigo-fg">{{ __('Resubmitted') }}
                                                    </span>
                                                @endif
                                            </div>
                                            <hr style="margin-top: 16px;">
