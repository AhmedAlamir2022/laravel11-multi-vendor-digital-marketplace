                    ...
                    <div class="dashboard-widget__content flx-between gap-1 align-items-end">
                        <div>
                            <h4 class="dashboard-widget__number mb-1 mt-3">
                                {{ currencyPosition(user()->withdraws()->whereStatus('pending')->sum('amount')) }}</h4>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="dashboard-widget red">
                    ...
                    <div class="dashboard-widget__content flx-between gap-1 align-items-end">
                        <div>
                            <h4 class="dashboard-widget__number mb-1 mt-3">
                                {{ currencyPosition(user()->withdraws()->whereStatus('paid')->sum('amount')) }}</h4>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="dashboard-widget red">
                    ...
                    <div class="dashboard-widget__content flx-between gap-1 align-items-end">
                        <div>
                            <h4 class="dashboard-widget__number mb-1 mt-3">
                                {{ currencyPosition(user()->authorSales()->sum('author_earning')) }}</h4>
