        ...
        <div class="row gy-4">
            <div class="col-lg-6">
                <div class="seller-item position-relative z-index-1"
                    style="background: url({{ asset('background_image_one') }});">
                    <h3 class="seller-item__title">banner_title_one </h3>
                    <p class="seller-item__desc fw-500 text-heading">banner_subtitle_one </p>
            ...
            <div class="col-lg-6">
                <div class="seller-item position-relative z-index-1"
                    style="background: url({{ asset('background_image_two') }});">
                    <h3 class="seller-item__title">banner_title_two </h3>
                    <p class="seller-item__desc fw-500 text-heading">banner_subtitle_two </p>
